...
export function BonusSection() {
  ...
  return (
    ...
    >
      ...
      <div
        id="offer-summary"
        className="mx-auto mt-12 max-w-4xl rounded-3xl bg-gradient-to-br from-[#2c1d62]/80 to-[#1a1338]/80 p-4 text-center shadow-[0_20px_80px_rgba(150,80,255,.35)] ring-1 ring-inset ring-white/10 backdrop-blur-md md:p-10"
      >
        <h2 className="font-headline text-xl font-extrabold text-white drop-shadow-lg md:text-4xl">
        ...
        <ul className="mx-auto mt-4 flex max-w-xl flex-col items-start gap-2 text-left">
          <li className="flex items-center gap-3">
            ...
            <span className="text-sm text-white/90 md:text-lg">
        ...
        <div className="mt-4 border-t border-dashed border-white/20 pt-4 md:mt-6 md:pt-6">
          ...
          <p className="text-xl md:text-3xl font-bold text-red-400 line-through">
            R$ 382,90
          </p>
